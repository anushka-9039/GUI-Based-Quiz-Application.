...
public class Quiz extends JFrame implements ActionListener {
    ...
    public void loadQuestions() {
        ...
        questions[4][0] = "Where is a String stored when created with the 'new' operator?";
        questions[4][1] = "Stack";
        questions[4][2] = "String memory";
        questions[4][3] = "Random storage";
        ...
        questions[6][0] = "Which keyword is used for accessing a package?";
        ...
        questions[8][0] = "Which of the following is mutable?";
        questions[8][1] = "java.lang.StringBuilder";
        questions[8][2] = "java.lang.Short";
        questions[8][3] = "java.lang.Byte";
        questions[8][4] = "java.lang.String";

        questions[9][0] = "What makes Java portable and secure?";
        questions[9][1] = "Bytecode is executed by JVM";
        questions[9][2] = "Applet makes code secure and portable";
        questions[9][3] = "Exception handling";
        questions[9][4] = "Dynamic binding";
    ...
    public void actionPerformed(ActionEvent ae) {
        if (ae.getSource() == next) {
            ...
            lifeline.setEnabled(false); // Disable the lifeline button after it's used
